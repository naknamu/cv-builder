...
const Experience = (props) => {
    ...
    const {changeCompany, changeCompAddress, changePosition, changeJobTask, changeJobFrom, changeJobTo, exp_counter} = props;
    // console.log(props);
    return ( 
        <div className="exp">
            <h3>Practical Experience</h3>
            <input type="text" name="company" id={exp_counter} placeholder="Company Name" onChange={changeCompany}/>
